...
# In the case of the pure diffusion, the Carr-Madan approach is about twice faster than the standard method
# (albeit obviously much slower than the analytic formula)
system.time(cdf1b <- CDF(cfBSM, p = p, cl = myc$cl, sv = sv, v = v^2))
system.time(cdf1c <- CDF(cfBSM, carrMadan = FALSE, p = p, cl = myc$cl, sv = sv, v = v^2))
...
# With the Heston model, the Carr-Madan is about four times faster
system.time(cdf2 <- CDF(cfHeston, p = p, cl = myc$cl, sv = sv,
                          v0 = v0, vT = vT, k = k, rho = rho, sigma = sigma))
system.time(cdf2b <- CDF(cfHeston, carrMadan = FALSE, p = p, cl = myc$cl, sv = sv,
                          v0 = v0, vT = vT, k = k, rho = rho, sigma = sigma))
...
system.time(cdf3 <- CDF(cfMerton, p = p, cl = myc$cl, sv = sv, v = v^2,
              lambda = lambda, muJ = muJ, vJ = vJ))
system.time(cdf3b <- CDF(cfMerton, carrMadan = FALSE, p = p, cl = myc$cl, sv = sv, v = v^2,
                          lambda = lambda, muJ = muJ, vJ = vJ))
...
# With the Merton model, the speed-up is about four
system.time(cdf4 <- CDF(cfBates, p = p, cl = myc$cl, sv = sv,
                          lambda = lambda, muJ = muJ, vJ = vJ,
                          v0 = v0, vT = vT, k = k, rho = rho, sigma = sigma))
system.time(cdf4b <- CDF(cfBates, carrMadan = FALSE, p = p, cl = myc$cl, sv = sv,
                           lambda = lambda, muJ = muJ, vJ = vJ,
                           v0 = v0, vT = vT, k = k, rho = rho, sigma = sigma))
